...
function Login({ setLoggedIn }: ILoginProps) {
    ...
    return <Form className="w-25">
        ...
        {!loggingIn && (
            <>
                <Form.Group>
                    <input style={{width: "45%"}} type="text" placeholder="First Name" onChange={e => setFirstName(e.target.value)}></input>
                    <input className="float-right" style={{width: "45%"}} type="text" placeholder="Last Name" onChange={e => setLastName(e.target.value)}></input>
                </Form.Group>
            </>
        )}
        <Form.Group>
            <input className="w-100" type="email" placeholder="Email" onChange={e => setEmail(e.target.value)}></input>
        </Form.Group>
        <Form.Group>
            <input className="w-100" type="password" placeholder="Password" onChange={e => setPassword(e.target.value)}></input>
        </Form.Group>
        <Form.Group>
