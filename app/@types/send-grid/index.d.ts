...
//      */
//     export class SendGridPersonalization {
...
//         getSubstitutions(): { [key: string]: string } //SendGridSubstitution[] //this appears to actually be a simple object with key/value pairs and not an array
...
//         API(request: Request, callback: (err: SendGridError, response: Response) => void): void
...
//     export type Response = SendGridResponse
// }
import Response from './reponse'

export type SendGridResponse = Response
